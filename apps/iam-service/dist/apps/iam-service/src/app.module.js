...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            prisma_module_1.PrismaModule.forRoot('iam'),
        ],
        controllers: [auth_controller_1.AuthController, users_controller_1.UserController, roles_controller_1.RoleController],
